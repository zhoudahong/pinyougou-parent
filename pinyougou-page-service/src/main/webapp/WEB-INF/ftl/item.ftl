...
<#include "head.ftl">
<#--图片列表：将数据库中的字符串转换成数组
"url":"http://192.168.25.133/group1/M00/00/00/wKgZhVnGbYuAO6AHAAjlKdWCzvg253.jpg"},
    ...
    <div id="item">
        ...
        <div class="fr itemInfo-wrap">
            ...
            <div class="clearfix choose">
                <div id="specificationL" class="summary-wrap clearfix">
                ...
                <div class="summary-wrap">
                    ...
                    <div class="fl">
                        <ul class="btn-choose unstyled">
                            <li>
                                <a target="_blank" class="sui-btn  btn-danger addshopcar" ng-click="addToCart()">
                                    加入购物车</a></li>
